...
class HeaderRaceComponent extends CBitrixComponent
{
    private $iblockId;
    private $currentDate;
    ...
    private function getClosestOffer()
    {
        ...
        $arSelect = ['ID', 'NAME', 'PROPERTY_DATE_START_RACE', 'PROPERTY_SUM_PLACES', 'PROPERTY_NEW_PRICE_RUB', 'PROPERTY_NEW_PRICE_USD'];
